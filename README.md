...
![alt text](https://github.com/AmanKadam-16/TimeSavers/blob/main/assets/Postman.png)
### Step 2, Paste it in the API Route Input field
![alt text](https://github.com/AmanKadam-16/TimeSavers/blob/main/assets/UI1.png)
### Step 3, Copy the body of API
![alt text](https://github.com/AmanKadam-16/TimeSavers/blob/main/assets/APIBody.png)
### Step 4, Paste the API Body in the Input JSON field
![alt text](https://github.com/AmanKadam-16/TimeSavers/blob/main/assets/UI2.png)
...
![alt text](https://github.com/AmanKadam-16/TimeSavers/blob/main/assets/APIResult.png)
### Step 6, Choose Response type as per your API output 
![alt text](https://github.com/AmanKadam-16/TimeSavers/blob/main/assets/UI3.png)
